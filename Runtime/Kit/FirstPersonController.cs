...
namespace Storyloom
{
    ...
    public class Crosshair : MonoBehaviour
    {
        ...
        void Update() { var p = StoryloomPlayer.Current as FirstPersonController; var d = StoryloomDirector.Instance; bool busy = d && (d.InBeat || d.UiBusy); if (dot) { dot.enabled = !busy; dot.color = p && p.Focus ? active : idle; dot.rectTransform.sizeDelta = p && p.Focus ? new Vector2(10, 10) : new Vector2(6, 6); } }
    }
}
